...
buf.push("<li><span" + (jade.cls(['cov',coverageClass(file.coverage)], [null,true])) + ">" + (jade.escape((jade_interp = file.coverage | 0) == null ? '' : jade_interp)) + "</span><a" + (jade.attr("href", '#' + (file.filename) + '', true, true)) + ">");
segments= file.filename.split('/')
basename= segments.pop()
if ( segments.length)
{
buf.push("<span class=\"dirname\">" + (jade.escape(null == (jade_interp = segments.join('/') + '/') ? "" : jade_interp)) + "</span>");
}
buf.push("<span class=\"basename\">" + (jade.escape(null == (jade_interp = basename) ? "" : jade_interp)) + "</span></a></li>");
    }
...
buf.push("<a id=\"logo\" href=\"http://visionmedia.github.io/mocha/\">m</a></div><div id=\"stats\"" + (jade.cls([coverageClass(cov.coverage)], [true])) + "><div class=\"percentage\">" + (jade.escape((jade_interp = cov.coverage | 0) == null ? '' : jade_interp)) + "%</div><div class=\"sloc\">" + (jade.escape(null == (jade_interp = cov.sloc) ? "" : jade_interp)) + "</div><div class=\"hits\">" + (jade.escape(null == (jade_interp = cov.hits) ? "" : jade_interp)) + "</div><div class=\"misses\">" + (jade.escape(null == (jade_interp = cov.misses) ? "" : jade_interp)) + "</div></div><div id=\"files\">");
// iterate cov.files
;(function(){
  var $$obj = cov.files;
  if ('number' == typeof $$obj.length) {
...
buf.push("<div class=\"file\"><h2" + (jade.attr("id", file.filename, true, true)) + ">" + (jade.escape(null == (jade_interp = file.filename) ? "" : jade_interp)) + "</h2><div id=\"stats\"" + (jade.cls([coverageClass(file.coverage)], [true])) + "><div class=\"percentage\">" + (jade.escape((jade_interp = file.coverage | 0) == null ? '' : jade_interp)) + "%</div><div class=\"sloc\">" + (jade.escape(null == (jade_interp = file.sloc) ? "" : jade_interp)) + "</div><div class=\"hits\">" + (jade.escape(null == (jade_interp = file.hits) ? "" : jade_interp)) + "</div><div class=\"misses\">" + (jade.escape(null == (jade_interp = file.misses) ? "" : jade_interp)) + "</div></div><table id=\"source\"><thead><tr><th>Line</th><th>Hits</th><th>Source</th></tr></thead><tbody>");
// iterate file.source
;(function(){
  var $$obj = file.source;
  if ('number' == typeof $$obj.length) {
...
if ( line.coverage > 0)
{
buf.push("<tr class=\"hit\"><td class=\"line\">" + (jade.escape(null == (jade_interp = number) ? "" : jade_interp)) + "</td><td class=\"hits\">" + (jade.escape(null == (jade_interp = line.coverage) ? "" : jade_interp)) + "</td><td class=\"source\">" + (jade.escape(null == (jade_interp = line.source) ? "" : jade_interp)) + "</td></tr>");
}
else if ( 0 === line.coverage)
{
buf.push("<tr class=\"miss\"><td class=\"line\">" + (jade.escape(null == (jade_interp = number) ? "" : jade_interp)) + "</td><td class=\"hits\">0</td><td class=\"source\">" + (jade.escape(null == (jade_interp = line.source) ? "" : jade_interp)) + "</td></tr>");
}
else
{
buf.push("<tr><td class=\"line\">" + (jade.escape(null == (jade_interp = number) ? "" : jade_interp)) + "</td><td class=\"hits\"></td><td class=\"source\">" + (jade.escape(null == (jade_interp = line.source || ' ') ? "" : jade_interp)) + "</td></tr>");
}
    }
...
buf.push("</div></div></body></html>");}.call(this,"cov" in locals_for_with?locals_for_with.cov:typeof cov!=="undefined"?cov:undefined,"coverageClass" in locals_for_with?locals_for_with.coverageClass:typeof coverageClass!=="undefined"?coverageClass:undefined,"segments" in locals_for_with?locals_for_with.segments:typeof segments!=="undefined"?segments:undefined,"basename" in locals_for_with?locals_for_with.basename:typeof basename!=="undefined"?basename:undefined));;return buf.join("");
}