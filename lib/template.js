...
buf.push("<li><span" + (jade.cls(['cov',coverageClass(file.coverage)], [null,true])) + ">" + (jade.escape((jade_interp = file.coverage | 0) == null ? '' : jade_interp)) + "</span><a" + (jade.attr("href", '#' + (file.filename) + '', true, false)) + ">");
